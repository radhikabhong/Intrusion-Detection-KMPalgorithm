...
<pre>    <img src="Out1.PNG" width="700" height="300">     </pre>
In Figure 2 the pattern is not found in input string hence index position value is None.
<pre>    <img src="Out2.PNG" width="700" height="300">     </pre>
